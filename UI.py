...
class AddNewSellerDlg ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"添加新的人员信息", pos = wx.DefaultPosition, size = wx.Size( 800,400 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.m_staticText_cell_phone = wx.StaticText( self, wx.ID_ANY, u"  移动电话  ", wx.DefaultPosition, wx.DefaultSize, 0 )
...
class GoOutRecodeCheckkDlg ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"外出记录单校验", pos = wx.DefaultPosition, size = wx.Size( 800,-1 ), style = wx.DEFAULT_DIALOG_STYLE )
		...
		self.m_staticText_path_s = wx.StaticText( self, wx.ID_ANY, u"  外出记录单 （原始） ", wx.DefaultPosition, wx.DefaultSize, 0 )
		self.m_staticText_path_s.Wrap( -1 )

		bSizerFilePathSource.Add( self.m_staticText_path_s , 0, wx.ALL, 5 )
		...
		self.m_staticText_path_d = wx.StaticText( self, wx.ID_ANY, u"  外出记录单（导出）   ", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText_blank1 = wx.StaticText( self, wx.ID_ANY, u"    ", wx.DefaultPosition, wx.DefaultSize, 0 )
		...
		self.m_staticText_blank2 = wx.StaticText( self, wx.ID_ANY, u"    ", wx.DefaultPosition, wx.DefaultSize, 0 )
